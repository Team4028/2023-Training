...
public interface BeakMotorController extends MotorController {
    ...
    /**
     * Convert a degree measure to the native units of this motor controller.
     * 
     * @param degrees Degree measure to convert.
     * @return NU representing rotation of the motor the specified amount of degrees.
     */
    default double degreesToNU(double degrees) {
		double nativeUnits = degrees * (getPositionEncoderCPR() / 360);
		return nativeUnits;
	}
	
    /**
     * Convert native units of this motor controller to a degree measure.
     * 
     * @param nu Native units to convert.
     * @return Degrees the motor rotates when it moves the specified amount of native units.
     */
	default double NUToDegrees(double nu) {
		double degrees = nu / (getPositionEncoderCPR() / 360);
		return degrees;
	}
}
